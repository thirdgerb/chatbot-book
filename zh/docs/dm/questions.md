...
而回答的处理, 可以通过 [Hearing API](/docs/dm/hearing.md) 来简化 :
...
> Suggestions 也可以使用 [Translator](/docs/engineer/translator.md) 进行转义, 因此可以用 replyId (详见 [Reply 一节](/docs/engineer/replies.md) ) 作为 Suggestion 的值.
